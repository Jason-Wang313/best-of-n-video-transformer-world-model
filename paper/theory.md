...
This tie-aware formula is useful because it separates the selection mechanism from the source of the candidates. Once a finite video pool has internal scores and executed utilities, the law predicts the expected selected utility of top-score Best-of-N selection.
